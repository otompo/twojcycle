    ...
    return (
        <Container fluid="md" style={{marginTop:'15px'}}>
            ...
            <Row>
             ...
             <Col md={6} className='my-5 social_contact'>
                <h2>Get in Touch</h2>
                ...
                harum corporis fuga corrupti. Doloribus quis
                 ...
                 <Row>
                     ...
                     <Col md={9}>
                        <h2>Email</h2>                        
                        <p>2jcycle@gmail.com</p>                     
                     </Col>

                     <Col md={3}>
                    
                      <Link to={{pathname: "https://web.facebook.com/2J-Cycle-107334804527713"}} target="_blank" >
                     <i class="fab fa-facebook-f"></i>
                     </Link>
                     </Col>
                     <Col md={3}>
                     <Link to={{pathname: "https://twitter.com/2JCycle1"}} target="_blank" >
                     <i class="fab fa-twitter"></i>
                     </Link>                 
                     </Col>                    
                     <Col md={3}>
                     <Link to={{pathname: "https://www.instagram.com/2j_cycle/"}} target="_blank" >
